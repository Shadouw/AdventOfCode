...
{
public:
    RopeBridge(const vector<string> &_input, int _knots) : input(_input), knots(_knots)
    {
    ...
    int getVisitedPositions( )
    {
        ...
        cout << "result A: " << VisitedPositions << endl;
        return VisitedPositions;
    }
...
{
    RopeBridge RopeBridgeData(inputData, 2);
    REQUIRE(6057 == RopeBridgeData.getVisitedPositions());
}

TEST_CASE("RopeBridge B")
{
    RopeBridge RopeBridgeData(inputData, 10);
    REQUIRE(2514 == RopeBridgeData.getVisitedPositions());
}