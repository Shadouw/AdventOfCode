...
public:
    ...
    void movegpselement(pair<long, long> &elem)
    {
        ...
        for (auto &e : gps)
            if (elem.second < newposition)
            {
                if (elem.second < e.second && e.second <= newposition)
                    --e.second;
            }
            else
            {
                if (newposition <= e.second && e.second < elem.second)
                    ++e.second;
            }
...
TEST_CASE("First Moves")
{
    ...
    REQUIRE("0, 4, 1, 2, -3, 3, -2" == GrovePositioningSystemData.getGPSString());
    GrovePositioningSystemData.movegpselement(1);
    REQUIRE("0, 4, 2, 1, -3, 3, -2" == GrovePositioningSystemData.getGPSString());
    GrovePositioningSystemData.movegpselement(2);
    REQUIRE("0, 4, 1, -3, 2, 3, -2" == GrovePositioningSystemData.getGPSString());
    GrovePositioningSystemData.movegpselement(-3);
    REQUIRE("0, 4, 1, 2, 3, -2, -3" == GrovePositioningSystemData.getGPSString());
    GrovePositioningSystemData.movegpselement(3);
    REQUIRE("0, 3, 4, 1, 2, -2, -3" == GrovePositioningSystemData.getGPSString());
    GrovePositioningSystemData.movegpselement(-2);
    REQUIRE("0, 3, 4, -2, 1, 2, -3" == GrovePositioningSystemData.getGPSString());
    GrovePositioningSystemData.movegpselement(0);
    REQUIRE("0, 3, 4, -2, 1, 2, -3" == GrovePositioningSystemData.getGPSString());
    GrovePositioningSystemData.movegpselement(4);
