...
public:
    ...
    long getResultB()
    {
        long resultB = firstspell * 10 + lastspell;
...
private:
    string input, inputspell;
    long first = -1, last = -1;
    long firstspell = -1, lastspell = -1;
...
TEST_CASE("Testdata")
{
    Trebuchet TrebuchetData(inputTestdata);
    REQUIRE(142 == TrebuchetData.getResultA());
}

TEST_CASE("Testdata1")
{
    Trebuchet TrebuchetData(inputTestdata2);
    REQUIRE(281 == TrebuchetData.getResultB());
}

TEST_CASE("Trebuchet")
{
    Trebuchet TrebuchetData(inputData);
    REQUIRE(55386 == TrebuchetData.getResultA());
    REQUIRE(54824 == TrebuchetData.getResultB());
}