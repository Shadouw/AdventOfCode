...
const vector<array<int, 3>> testdata = {{{810, 679, 10},
                                         {783, 255, 616},
                                         {545, 626, 626},
                                         {84, 910, 149},
                                         {607, 425, 901},
...
{
public:
    triangles(const vector<array<int, 3>> &_input) : input(_input)
    {
        cout << "Size of Input: " << input.size() << endl;
    }

    int checkPossibleTriangle()
    {
        int resultA = 0;
        for (auto elem : input)
        {
            if (elem[0] + elem[1] > elem[2] && elem[1] + elem[2] > elem[0] && elem[0] + elem[2] > elem[1])
                ++resultA;
        }
        return resultA;
    }
